...
const color=(a)=>{
 ...
 AddStudent
   ...
   <h1 style={{color:"#0E2431",fontFamily:"'Poppins',sans-serif"}} >All Workingday Leave Request</h1> 
  </div>
  </center>
...
<tbody>
  {users.map(a=>{
      ...
      <td><Link to={`/userrr/${a._id}`}><button className='but'>Update</button></Link></td>
